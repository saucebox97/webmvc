...
public class FrontControllerV1 extends HttpServlet {
    ...
    private final Map<String, ControllerV1> controllerV1Map
                                            = new HashMap<>();

    public FrontControllerV1() {
        controllerV1Map.put("/mvc/v1/join", new FormController());
        controllerV1Map.put("/mvc/v1/save", new SaveController());
        controllerV1Map.put("/mvc/v1/show", new ShowController());
    }
